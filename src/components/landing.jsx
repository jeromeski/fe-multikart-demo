	...
	componentDidMount() {
		...
		sky.addEventListener('mousemove', function(e) {
			...
			elemOne.style.transform =
				'translateX(' + (7 + pageX / 150) + '%) translateY(' + (1 + pageY / 150) + '%)';
							...
							<div className='col-12'>
								<div className='feature text-center'>
									<div>
										...
										<p className='pb-3'>
											Multikart HTML template is an apparently simple but highly functional
											tempalate designed for creating a flourisahing online business.
										</p>
									</div>
								</div>
							</div>
								...
								<div className='feature-box'>
									<div className='feature-image'>
										<img
											...
											}/assets/images/landing-page/main-features/demo.png`}
											alt='img'
										/>
									</div>
									...
									<p className='para'>
										Multikart is a clean and morfern responsive template.it will perfectly suit for
										any type of online store
									</p>
								</div>
							</div>
							<div className='col-xl-3 col-md-6 '>
								<div className='feature-box'>
									<div className='feature-image'>
										<img
											...
											src={`${
												process.env.PUBLIC_URL
											}/assets/images/landing-page/main-features/dashboard.png`}
											alt='img'
										/>
									</div>
									<div className='feature-content'>
									...
									<p className='para'>
										Multikart has powerful backend admin panel to manage products, sales, discount
										coupons, orders, user, vendor and much more.
									</p>
								</div>
							</div>
							<div className='col-xl-3 col-md-6'>
								<div className='feature-box'>
									<div className='feature-image'>
										<img
											...
											src={`${
												process.env.PUBLIC_URL
											}/assets/images/landing-page/main-features/email.png`}
											alt='img'
										/>
									</div>
									<div className='feature-content'>
									...
									<p className='para'>
										Multikart comes with 4 email template which include two order success template &
										two email template
									</p>
								</div>
							</div>
								...
								<div className='feature-box'>
									<div className='feature-image'>
										<img
											...
											src={`${
												process.env.PUBLIC_URL
											}/assets/images/landing-page/main-features/portfoio.png`}
											alt='img'
										/>
									</div>
									<div className='feature-content'>
									...
									<p className='para'>
										Multikart provides multiple portfolio pages which includes 3 grid view & 4
										masonary view.
									</p>
								</div>
							</div>
								...
								<div className='feature-box'>
									<div className='feature-image'>
										<img
											...
											src={`${
												process.env.PUBLIC_URL
											}/assets/images/landing-page/main-features/lazy.png`}
											alt='img'
										/>
									</div>
									<div className='feature-content'>
									...
									<p className='para'>
										Make your web page faster by using lazy loaded. Lazy Load is delays loading of
										images in long web pages. Images outside of viewport are not loaded until user
										scrolls to them.
									</p>
								</div>
							</div>
								...
								<div className='feature-box'>
									<div className='feature-image'>
										<img
											...
											src={`${
												process.env.PUBLIC_URL
											}/assets/images/landing-page/main-features/Unlimited-product-size.png`}
											alt='img'
										/>
									</div>
									<div className='feature-content'>
									...
									<p className='para'>
										Every store has different image size weather its tools or fashion we have
										covered all image size for all your store needs , it has auto resize image
										option in multikart
									</p>
								</div>
							</div>
								...
								<div className='feature-box'>
									<div className='feature-image'>
										<img
											...
											src={`${
												process.env.PUBLIC_URL
											}/assets/images/landing-page/main-features/Dark-light.png`}
											alt='img'
										/>
									</div>
									<div className='feature-content'>
									...
									<p className='para'>
										Useful feature for Night Owls or people who work during the night. The dark
										background will put less strain on the eyes.
									</p>
								</div>
							</div>
							<div className='col-xl-3 col-md-6'>
								<div className='feature-box'>
									<div className='feature-image'>
										<img
											...
											src={`${
												process.env.PUBLIC_URL
											}/assets/images/landing-page/main-features/rtl.png`}
											alt='img'
										/>
									</div>
									<div className='feature-content'>
									...
									<p className='para'>
										Design your website LTR or RTL , Multikart supports multi-languages so its easy
										to design website on any layout such as arabic , urdu..
									</p>
								</div>
							</div>
						</div>
										...
										<div className='col-xl-3 col-sm-6 col-12 demo-box'>
											<Link to={`${process.env.PUBLIC_URL}/fashion`} target='_blank'>
												<img
													src={`${
														process.env.PUBLIC_URL
													}/assets/images/landing-page/special features/1.jpg`}
													className='img-fluid lazyload'
												/>
											</Link>
										...
										<div className='col-xl-3 col-sm-6 col-12 demo-box'>
											<Link to={`${process.env.PUBLIC_URL}/pets`} target='_blank'>
												<img
													src={`${
														process.env.PUBLIC_URL
													}/assets/images/landing-page/special features/8.jpg`}
													className='img-fluid lazyload'
												/>
											</Link>
											<h3>
										...
										<div className='col-xl-3 col-sm-6 col-12 demo-box'>
											<Link to={`${process.env.PUBLIC_URL}/watch`} target='_blank'>
												<img
													src={`${
														process.env.PUBLIC_URL
													}/assets/images/landing-page/special features/15.jpg`}
													className='img-fluid lazyload'
												/>
											</Link>
											<h3>
										...
										<div className='col-xl-3 col-sm-6 col-12 demo-box'>
											<Link to={`${process.env.PUBLIC_URL}/kids`} target='_blank'>
												<img
													src={`${
														process.env.PUBLIC_URL
													}/assets/images/landing-page/special features/16.jpg`}
													className='img-fluid lazyload'
												/>
											</Link>
											<h3>
										...
										<div className='col-xl-3 col-sm-6 col-12 demo-box'>
											<Link to={`${process.env.PUBLIC_URL}/vegetables`} target='_blank'>
												<img
													src={`${
														process.env.PUBLIC_URL
													}/assets/images/landing-page/special features/19.jpg`}
													className='img-fluid lazyload'
												/>
											</Link>
											<h3>
												vegetables <span className='badge badge-danger'>New</span>
											</h3>
										</div>
										<div className='col-xl-3 col-sm-6 col-12 demo-box'>
											<Link to={`${process.env.PUBLIC_URL}/beauty`} target='_blank'>
												<img
													src={`${
														process.env.PUBLIC_URL
													}/assets/images/landing-page/special features/20.jpg`}
													className='img-fluid lazyload'
												/>
											</Link>
											<h3>
										...
										<div className='col-xl-3 col-sm-6 col-12 demo-box'>
											<Link to={`${process.env.PUBLIC_URL}/electronic`} target='_blank'>
												<img
													src={`${
														process.env.PUBLIC_URL
													}/assets/images/landing-page/special features/25.jpg`}
													className='img-fluid lazyload'
												/>
											</Link>
											<h3>
												electronic classic <span className='badge badge-danger'>New</span>
											</h3>
										</div>
										<div className='col-xl-3 col-sm-6 col-12 demo-box'>
											<Link to={`${process.env.PUBLIC_URL}/furniture`} target='_blank'>
												<img
													src={`${
														process.env.PUBLIC_URL
													}/assets/images/landing-page/special features/30.jpg`}
													className='img-fluid lazyload'
												/>
											</Link>
											<h3>
												furniture <span className='badge badge-danger'>New</span>
											</h3>
										</div>
									</div>
								</div>
										...
										<div className='col-xl-3 col-sm-6 col-12 demo-box'>
											<Link to={`${process.env.PUBLIC_URL}/col-left/product/1`} target='_blank'>
												<img
													src={`${
														process.env.PUBLIC_URL
													}/assets/images/landing-page/special features/product/1.jpg`}
													className='img-fluid lazyload'
												/>
												<h3>3 col left</h3>
											</Link>
										...
										<div className='col-xl-3 col-sm-6 col-12 demo-box'>
											<Link to={`${process.env.PUBLIC_URL}/col-left/product/1`} target='_blank'>
												<img
													src={`${
														process.env.PUBLIC_URL
													}/assets/images/landing-page/special features/product/2.jpg`}
													className='img-fluid lazyload'
												/>
												<h3>3 col right</h3>
											</Link>
										...
										<div className='col-xl-3 col-sm-6 col-12 demo-box'>
											<Link to={`${process.env.PUBLIC_URL}/column/product/1`} target='_blank'>
												<img
													src={`${
														process.env.PUBLIC_URL
													}/assets/images/landing-page/special features/product/3.jpg`}
													className='img-fluid lazyload'
												/>
												<h3>3 column</h3>
											</Link>
										...
										<div className='col-xl-3 col-sm-6 col-12 demo-box'>
											<Link to={`${process.env.PUBLIC_URL}/accordian/product/1`} target='_blank'>
												<img
													src={`${
														process.env.PUBLIC_URL
													}/assets/images/landing-page/special features/product/4.jpg`}
													className='img-fluid lazyload'
												/>
												<h3>accordian</h3>
											</Link>
										...
										<div className='col-xl-3 col-sm-6 col-12 demo-box'>
											<Link to={`${process.env.PUBLIC_URL}/left-image/product/1`} target='_blank'>
												<img
													src={`${
														process.env.PUBLIC_URL
													}/assets/images/landing-page/special features/product/5.jpg`}
													className='img-fluid lazyload'
												/>
												<h3>left image</h3>
											</Link>
										...
										<div className='col-xl-3 col-sm-6 col-12 demo-box'>
											<Link to={`${process.env.PUBLIC_URL}/left-sidebar/product/1`} target='_blank'>
												<img
													src={`${
														process.env.PUBLIC_URL
													}/assets/images/landing-page/special features/product/6.jpg`}
													className='img-fluid lazyload'
												/>
												<h3>left sidebar</h3>
											</Link>
										...
										<div className='col-xl-3 col-sm-6 col-12 demo-box'>
											<Link to={`${process.env.PUBLIC_URL}/no-sidebar/product/1`} target='_blank'>
												<img
													src={`${
														process.env.PUBLIC_URL
													}/assets/images/landing-page/special features/product/7.jpg`}
													className='img-fluid lazyload'
												/>
												<h3>no sidebar</h3>
											</Link>
										...
										<div className='col-xl-3 col-sm-6 col-12 demo-box'>
											<Link to={`${process.env.PUBLIC_URL}/right-image/product/1`} target='_blank'>
												<img
													src={`${
														process.env.PUBLIC_URL
													}/assets/images/landing-page/special features/product/8.jpg`}
													className='img-fluid lazyload'
												/>
												<h3>right image</h3>
											</Link>
										...
										<div className='col-xl-3 col-sm-6 col-12 demo-box'>
											<Link
												...
												<img
													src={`${
														process.env.PUBLIC_URL
													}/assets/images/landing-page/special features/product/9.jpg`}
													className='img-fluid lazyload'
												/>
												<h3>right sidebar</h3>
											</Link>
										...
										<div className='col-xl-3 col-sm-6 col-12 demo-box'>
											<Link to={`${process.env.PUBLIC_URL}/vertical/product/1`} target='_blank'>
												<img
													src={`${
														process.env.PUBLIC_URL
													}/assets/images/landing-page/special features/product/11.jpg`}
													className='img-fluid lazyload'
												/>
												<h3>vertical tab</h3>
											</Link>
										...
										<div className='col-xl-3 col-sm-6 col-12 demo-box'>
											<Link to={`${process.env.PUBLIC_URL}/metro/collection`} target='_blank'>
												<img
													src={`${
														process.env.PUBLIC_URL
													}/assets/images/landing-page/special features/shop/6.jpg`}
													className='img-fluid lazyload'
												/>
												<h3>
										...
										<div className='col-xl-3 col-sm-6 col-12 demo-box'>
											<Link to={`${process.env.PUBLIC_URL}/full-width/collection`} target='_blank'>
												<img
													src={`${
														process.env.PUBLIC_URL
													}/assets/images/landing-page/special features/shop/10.jpg`}
													className='img-fluid lazyload'
												/>
												<h3>
													full width <span className='badge badge-danger'>New</span>
												</h3>
											</Link>
										</div>
										<div className='col-xl-3 col-sm-6 col-12 demo-box'>
											<Link
												...
												<img
													src={`${
														process.env.PUBLIC_URL
													}/assets/images/landing-page/special features/shop/1.jpg`}
													className='img-fluid lazyload'
												/>
												<h3>left sidebar</h3>
											</Link>
										...
										<div className='col-xl-3 col-sm-6 col-12 demo-box'>
											<Link to={`${process.env.PUBLIC_URL}/no-sidebar/collection`} target='_blank'>
												<img
													src={`${
														process.env.PUBLIC_URL
													}/assets/images/landing-page/special features/shop/2.jpg`}
													className='img-fluid lazyload'
												/>
												<h3>no sidebar</h3>
											</Link>
										...
										<div className='col-xl-3 col-sm-6 col-12 demo-box'>
											<Link
												...
												<img
													src={`${
														process.env.PUBLIC_URL
													}/assets/images/landing-page/special features/shop/3.jpg`}
													className='img-fluid lazyload'
												/>
												<h3>right sidebar</h3>
											</Link>
										...
										<div className='col-xl-3 col-sm-6 col-12 demo-box'>
											<Link
												...
												<img
													src={`${
														process.env.PUBLIC_URL
													}/assets/images/landing-page/special features/shop/4.jpg`}
													className='img-fluid lazyload'
												/>
												<h3>sidebar popup</h3>
											</Link>
										...
										<div className='col-xl-3 col-sm-6 col-12 demo-box'>
											<Link
												...
												<img
													src={`${
														process.env.PUBLIC_URL
													}/assets/images/landing-page/special features/shop/5.jpg`}
													className='img-fluid lazyload'
												/>
										...
										<div className='col-xl-3 col-sm-6 col-12 demo-box'>
											<Link
												...
												<img
													src={`${
														process.env.PUBLIC_URL
													}/assets/images/landing-page/special features/shop/7.jpg`}
													className='img-fluid lazyload'
												/>
												<h3>3 grid</h3>
											</Link>
										...
										<div className='col-xl-3 col-sm-6 col-12 demo-box'>
											<Link
												...
												<img
													src={`${
														process.env.PUBLIC_URL
													}/assets/images/landing-page/special features/shop/8.jpg`}
													className='img-fluid lazyload'
												/>
												<h3>6 grid</h3>
											</Link>
										...
										<div className='col-xl-3 col-sm-6 col-12 demo-box'>
											<Link
												...
												<img
													src={`${
														process.env.PUBLIC_URL
													}/assets/images/landing-page/special features/shop/9.jpg`}
													className='img-fluid lazyload'
												/>
												<h3>list view</h3>
											</Link>
										...
										<div className='col-xl-3 col-sm-6 col-12 demo-box'>
											<Link to={`${process.env.PUBLIC_URL}/wishlist`} target='_blank'>
												<img
													src={`${
														process.env.PUBLIC_URL
													}/assets/images/landing-page/special features/other/1.jpg`}
													className='img-fluid lazyload'
												/>
											</Link>
											<h3>wishlist</h3>
										...
										<div className='col-xl-3 col-sm-6 col-12 demo-box'>
											<Link to={`${process.env.PUBLIC_URL}/cart`} target='_blank'>
												<img
													src={`${
														process.env.PUBLIC_URL
													}/assets/images/landing-page/special features/other/2.jpg`}
													className='img-fluid lazyload'
												/>
											</Link>
											<h3>cart</h3>
										...
										<div className='col-xl-3 col-sm-6 col-12 demo-box'>
											<Link to={`${process.env.PUBLIC_URL}/pages/dashboard`} target='_blank'>
												<img
													src={`${
														process.env.PUBLIC_URL
													}/assets/images/landing-page/special features/other/3.jpg`}
													className='img-fluid lazyload'
												/>
											</Link>
											<h3>dashboard</h3>
										...
										<div className='col-xl-3 col-sm-6 col-12 demo-box'>
											<Link to={`${process.env.PUBLIC_URL}/pages/login`} target='_blank'>
												<img
													src={`${
														process.env.PUBLIC_URL
													}/assets/images/landing-page/special features/other/4.jpg`}
													className='img-fluid lazyload'
												/>
											</Link>
											<h3>login</h3>
										...
										<div className='col-xl-3 col-sm-6 col-12 demo-box'>
											<Link to={`${process.env.PUBLIC_URL}/pages/register`} target='_blank'>
												<img
													src={`${
														process.env.PUBLIC_URL
													}/assets/images/landing-page/special features/other/5.jpg`}
													className='img-fluid lazyload'
												/>
											</Link>
											<h3>register</h3>
										...
										<div className='col-xl-3 col-sm-6 col-12 demo-box'>
											<Link to={`${process.env.PUBLIC_URL}/pages/contact`} target='_blank'>
												<img
													src={`${
														process.env.PUBLIC_URL
													}/assets/images/landing-page/special features/other/6.jpg`}
													className='img-fluid lazyload'
												/>
											</Link>
											<h3>contact us</h3>
										...
										<div className='col-xl-3 col-sm-6 col-12 demo-box'>
											<Link to={`${process.env.PUBLIC_URL}/pages/forgot-password`} target='_blank'>
												<img
													src={`${
														process.env.PUBLIC_URL
													}/assets/images/landing-page/special features/other/7.jpg`}
													className='img-fluid lazyload'
												/>
											</Link>
										...
										<div className='col-xl-3 col-sm-6 col-12 demo-box'>
											<Link to={`${process.env.PUBLIC_URL}/checkout`} target='_blank'>
												<img
													src={`${
														process.env.PUBLIC_URL
													}/assets/images/landing-page/special features/other/9.jpg`}
													className='img-fluid lazyload'
												/>
											</Link>
											<h3>checkout</h3>
										...
										<div className='col-xl-3 col-sm-6 col-12 demo-box'>
											<Link to={`${process.env.PUBLIC_URL}/pages/about-us`} target='_blank'>
												<img
													src={`${
														process.env.PUBLIC_URL
													}/assets/images/landing-page/special features/other/10.jpg`}
													className='img-fluid lazyload'
												/>
											</Link>
											<h3>about us</h3>
										...
										<div className='col-xl-3 col-sm-6 col-12 demo-box'>
											<Link to={`${process.env.PUBLIC_URL}/pages/search`} target='_blank'>
												<img
													src={`${
														process.env.PUBLIC_URL
													}/assets/images/landing-page/special features/other/11.jpg`}
													className='img-fluid lazyload'
												/>
											</Link>
											<h3>search</h3>
										...
										<div className='col-xl-3 col-sm-6 col-12 demo-box'>
											<Link to={`${process.env.PUBLIC_URL}/compare`} target='_blank'>
												<img
													src={`${
														process.env.PUBLIC_URL
													}/assets/images/landing-page/special features/other/15.jpg`}
													className='img-fluid lazyload'
												/>
											</Link>
											<h3>compare </h3>
										...
										<div className='col-xl-3 col-sm-6 col-12 demo-box'>
											<Link to={`${process.env.PUBLIC_URL}/pages/collection`} target='_blank'>
												<img
													src={`${
														process.env.PUBLIC_URL
													}/assets/images/landing-page/special features/other/17.jpg`}
													className='img-fluid lazyload'
												/>
											</Link>
											<h3>collection</h3>
										...
										<div className='col-xl-3 col-sm-6 col-12 demo-box'>
											<Link to={`${process.env.PUBLIC_URL}/pages/lookbook`} target='_blank'>
												<img
													src={`${
														process.env.PUBLIC_URL
													}/assets/images/landing-page/special features/other/18.jpg`}
													className='img-fluid lazyload'
												/>
											</Link>
											<h3>lookbook</h3>
										...
										<div className='col-xl-3 col-sm-6 col-12 demo-box'>
											<Link to={`${process.env.PUBLIC_URL}/pages/404`} target='_blank'>
												<img
													src={`${
														process.env.PUBLIC_URL
													}/assets/images/landing-page/special features/other/20.jpg`}
													className='img-fluid lazyload'
												/>
											</Link>
											<h3>404</h3>
										...
										<div className='col-xl-3 col-sm-6 col-12 demo-box'>
											<Link to={`${process.env.PUBLIC_URL}/pages/faq`} target='_blank'>
												<img
													src={`${
														process.env.PUBLIC_URL
													}/assets/images/landing-page/special features/other/22.jpg`}
													className='img-fluid lazyload'
												/>
											</Link>
											<h3>FAQ</h3>
										...
										<div className='col-xl-3 col-sm-6 col-12 demo-box'>
											<Link to={`${process.env.PUBLIC_URL}/blog/details`} target='_blank'>
												<img
													src={`${
														process.env.PUBLIC_URL
													}/assets/images/landing-page/special features/blog/1.jpg`}
													className='img-fluid lazyload'
												/>
											</Link>
											<h3>blog deatils</h3>
										...
										<div className='col-xl-3 col-sm-6 col-12 demo-box'>
											<Link to={`${process.env.PUBLIC_URL}/blog/blog-page`} target='_blank'>
												<img
													src={`${
														process.env.PUBLIC_URL
													}/assets/images/landing-page/special features/blog/3.jpg`}
													className='img-fluid lazyload'
												/>
											</Link>
											<h3>left sidebar</h3>
										...
										<div className='col-xl-3 col-sm-6 col-12 demo-box'>
											<Link to={`${process.env.PUBLIC_URL}/blog/right-sidebar`} target='_blank'>
												<img
													src={`${
														process.env.PUBLIC_URL
													}/assets/images/landing-page/special features/blog/4.jpg`}
													className='img-fluid lazyload'
												/>
											</Link>
											<h3>right sidebar</h3>
						...
						<div className='row'>
							<div className='col-md-3 left-part'>
								<img
									src={`${
										process.env.PUBLIC_URL
									}/assets/images/landing-page/email%20template/1.jpg`}
									alt=''
								...
								<div className='sticker'>
									<img
										src={`${
											process.env.PUBLIC_URL
										}/assets/images/landing-page/email%20template/sticker.png`}
										alt=''
										className='img-fluid lazyload'
									/>
								</div>
							...
							<div className='col-md-4 offset-md-1 text-center center-part'>
								...
								<p className='pb-3'>
									Multikart come with 4+ email template which include two order success template &
									two email template{' '}
								</p>
								<img
									src={`${
										process.env.PUBLIC_URL
									}/assets/images/landing-page/email%20template/2.jpg`}
									alt=''
								...
								<div className='res-img'>
									<img
										src={`${
											process.env.PUBLIC_URL
										}/assets/images/landing-page/email%20template/1.png`}
										alt=''
										className='img-fluid lazyload'
									/>
								</div>
							...
							<div className='col-md-3 offset-md-1 right-part'>
								<img
									src={`${
										process.env.PUBLIC_URL
									}/assets/images/landing-page/email%20template/3.jpg`}
									alt=''
									className='img-fluid lazyload email-img'
								/>
							</div>
							...
							<div className='col'>
								<div className='footer-section'>
									<div>
										...
										<h2>
											purchase the multikart <br />& create beautiful online store
										</h2>
										<a
											target='_blank'
